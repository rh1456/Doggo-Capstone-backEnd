  ...
  public class UserController : ControllerBase
  {
    ...
    public async Task<ActionResult<IEnumerable<User>>> GetUsers()
    {
      ...
      var rv = userResults.Select(user => new UserItem
      {
        ...
        Sex = user.Gender.Sex,
        InterestLevel = user.InterestedEnergyLevel.EnergyLevelId
      });
      return Ok(rv);
    }
    ...
    public async Task<ActionResult<User>> GetUser(int id)
    {
      ...
      var rv = new UserItem
      {
        ...
        InterestLevel = userResults.InterestedEnergyLevel.EnergyLevel
      };
      return Ok(rv);
    }
    ...
    public async Task<ActionResult<User>> PostUser(NewUserViewModel vm)
    {
      ...
      var interest = db.InterestedEnergyLevel.FirstOrDefault(f => f.Id == vm.InterestedEnergyLevelId);
      if (energyLevel == null)
      {
        return NotFound();
      }
