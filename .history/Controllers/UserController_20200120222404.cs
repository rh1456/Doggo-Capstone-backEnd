...
namespace Doggo_Capstone_backEnd.Controllers
{
  ...
  public class UserController : ControllerBase
  {
    ...
    {
      var db = new DatabaseContext();
      var userResults = db.Users.Include(i => i.EnergyLevel).Include(i => i.Gender).FirstOrDefault(userResults => userResults.Id == id);
      ...
      var rv = new UserItem
      {
        ...
        Breed = userResults.Breed,
        Size = userResults.Size,
        Sex = userResults.GenderId,
        Level = userResults.EnergyLevelId
      });
      return Ok(rv);
    }
